  ...
  return (
    <section className="max-w-7xl mx-auto px-3 lg:px-0 py-12">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-0 p-3 lg:p-4 lg:pb-0 items-center rounded-3xl">
        {/* Texto */}
        <div className="lg:col-span-7 order-2 lg:order-1 p-0 lg:p-3 lg:pt-3">
          <h1 className="text-[2rem] md:text-4xl lg:text-5xl font-bold leading-tight mb-3 text-center lg:text-left"
              style={{ color: "#eb7700" }}>
            What We Do
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-2 justify-center lg:justify-start mb-4 lg:mb-3">
            ...
            <Button asChild variant="outline"
              ...
              <Link href="/bags" title="products">Bags</Link>
            </Button>

            {/* Textiles */}
            <Button asChild variant="outline"
              className="px-6 border-[#1f5bd3] text-[#1f5bd3] hover:bg-[#1f5bd3] hover:text-white">
              <Link href="/textiles" title="products">Textiles</Link>
            </Button>

            {/* Services (outline secondary estilo neutro) */}
            {/* <Button asChild variant="outline"
        ...
        {/* Imagen */}
        <div className="lg:col-span-5 order-2 lg:order-2 mb-4 lg:mb-0">
