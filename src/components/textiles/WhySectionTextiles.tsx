...
export default function WhySectionTextiles() {
  return (
    <>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-6">
          ...
          >
            ...
            <p className="mb-6 text-gray-700">
              ...
              process reliability across our textile portfolio—supporting critical
              applications from packaging to infrastructure.
            </p>
